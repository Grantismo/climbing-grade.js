describe("ClimbingGrade", function() {
  ...
  it("can convert grades into ranges where appropriate", function() {
    ...
    var converted = heuco.format("font");
  ...
  it("can format grades appropriately", function() {
    var heuco = new ClimbingGrade("v6", "heuco");
    expect(heuco.format("heuco")).toBe("V6");
    expect(heuco.format("uiaa")).toBe("IX+");
    expect(heuco.format("font")).toBe("7A");
    expect(heuco.format("british")).toBe("E6 6c");
  });
